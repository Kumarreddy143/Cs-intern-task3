...
Step-6:- And i download the Complete list of vulnerabilities by host which is saved as a scandown.

Note:- If you want to see the scan result you need to download the result files in git hub. 
       Otherwise your able to see the code only. 